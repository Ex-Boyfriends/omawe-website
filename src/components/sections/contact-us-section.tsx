...
export function ContactUsSection() {
  return (
    ...
    >
      <div className="mx-auto max-w-[832px] p-6 text-center sm:border sm:border-black/50 sm:bg-black/10 sm:p-10 sm:backdrop-blur">
        ...
        <h2 className="type-title-1 mt-3 text-white sm:type-large-title">
